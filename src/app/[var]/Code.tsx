 ...
 useEffect(() => {
  ...
  return (
    <main>
      ...
      <WhyGoGradesTest country={country} city={city} title={headder} locationDetails={locationDetails} />
      <TrustedPartnerTest locationDetails={locationDetails} number={number} />
      ...
      <EveryStudentTest locationDetails={locationDetails} number={number} />
      <ReviewsTest />

...
export const metalist = [
  {
    url: "aus",
    metatitle: "Best Academic Consultancy | Gogrades.org",
    metadescription:
    ...
    <main>
     <title>Best Academic Consultancy | Gogrades.org</title>
      <meta
        ...
        key="desc"
      />
      <link rel="canonical" href={`https://gogrades.org/uk/${slug}`}></link>
      ...
      <OurServicesTest number={number} title="Academic Consultancy" region={"/uk"} />
      <WhyGoGradesTest
        country={country}
        city={city}
        title="Academic Consultancy"
      ...
      <FreeSampleTest country={country} title="Academic Consultancy" region={"/uk"} />

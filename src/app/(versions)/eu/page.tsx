...
export default function Code(props: any) {
  ...
  return (
    <main>
      ...
      <link rel="canonical" href={`https://gogrades.org/eu/${slug}`}></link>
      ...
      <OurServicesTest number={number} title="Academic Consultancy" region={"/eu"} />
      <WhyGoGradesTest
        country={country}
        city={city}
        title="Academic Consultancy"
      ...
      <FreeSampleTest country={country} title="Academic Consultancy" region={"/eu"} />
